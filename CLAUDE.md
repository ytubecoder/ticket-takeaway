...
## CRITICAL: Never Edit PRODUCT_BACKLOG.md Directly

`PRODUCT_BACKLOG.md` is **auto-generated from the SQLite database**. Any direct edits will be overwritten on the next CLI operation.

**ALL ticket changes MUST go through `tickets-cli.py`:**
...
Every CLI write auto-syncs the DB back to PRODUCT_BACKLOG.md. You can read PRODUCT_BACKLOG.md for context, but never write to it.
...
- `PRODUCT_BACKLOG.md` — **auto-generated from SQLite DB** by `tickets-cli.py sync`. Do not edit directly.
